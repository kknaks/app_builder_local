...
| S2-BE | 토큰/프로젝트 CRUD API | 🔄 진행중 | - |
| S2-FE | 3패널 레이아웃 + 대시보드 기본 | 🔄 진행중 | - |
| S3-BE | 에이전트 엔진 + 채팅/로그 WS | ⏳ 대기 | - |
| S3-FE | 채팅/로그 UI + 상태 관리 | ⏳ 대기 | - |
| S4-BE | 기획 플로우 (Planner + 검증) | ⏳ 대기 | - |
| S4-FE | 기획 UI + 플로우 시각화 | ⏳ 대기 | - |
| S5 | 구현 플로우 + 에러 자동 수정 | ⏳ 대기 | - |
